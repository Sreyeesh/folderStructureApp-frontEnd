...
parser.add_argument("-index",  action="store_true", default=False,help=' use command -i to open up index.html before the folder name fooBar/')
...
if not os.path.exists(args.name + "/index.html"):
    with open(args.name + "/index.html", "w") as f:
